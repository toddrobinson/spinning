...
<div class="row">
  <div class="col-md-12 text-center">
    <input class="btn btn-primary" type="button" value="START!" id="startButton">
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <h3 clas="text-center">Overall Completion <small>Completed Time:  <span id="totalTimeLeft"> </span> {{$track->length}}</small></h3>
